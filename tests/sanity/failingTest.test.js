...
describe('@Sanity - Failing Test', function() {
  this.timeout(30000)
  let driver
  let vars
  ...
  it('should fail if home page title is not correct', async function() {
    ...
    assert(await driver.findElement(By.css(".title")).getText() == "Productzz")
  })
})
